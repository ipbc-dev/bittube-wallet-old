## Libwebsockets Start
set(PARENT_PROJECT_NAME "parent")

if (DEFINED CN_PROJECT_NAME)
     message("CN_PROJECT_NAME is defined: ${CN_PROJECT_NAME}")
     set(PARENT_PROJECT_NAME ${CN_PROJECT_NAME})
     message("Parent project name: ${PARENT_PROJECT_NAME}")
 else()
     message("CN_PROJECT_NAME is NOT defined")
endif()
